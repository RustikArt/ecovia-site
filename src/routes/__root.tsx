...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: siteConfig.seo.defaultDescription },
      { name: "keywords", content: siteConfig.seo.defaultKeywords.join(", ") },
      { property: "og:url", content: siteConfig.seo.siteUrl },
      { property: "og:locale", content: siteConfig.seo.locale },
